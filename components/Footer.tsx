    ...
    <footer style={{ backgroundColor: "#030508" }}>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="py-16 md:py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1">
            <Link href="/" className="inline-block mb-6">
              <Image src="/logo.png" alt="AMEPRA" width={120} height={44} className="h-8 w-auto opacity-80" />
            </Link>
            ...
            <div className="space-y-3">
              <a href="tel:+420221180260" className="flex items-center gap-2.5 text-sm transition-colors hover:text-white" style={{ color: "rgba(240,237,230,0.55)" }}>
              ...
              <a href="mailto:info@amepra.cz" className="flex items-center gap-2.5 text-sm transition-colors hover:text-white" style={{ color: "rgba(240,237,230,0.55)" }}>
          ...
          <div>
            <h3 className="text-[10px] font-semibold uppercase tracking-[0.2em] mb-5" style={{ color: "rgba(200,169,110,0.5)" }}>Navigace</h3>
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm transition-colors hover:text-white" style={{ color: "rgba(240,237,230,0.5)" }}>{link.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            <h3 className="text-[10px] font-semibold uppercase tracking-[0.2em] mb-5" style={{ color: "rgba(200,169,110,0.5)" }}>Naše služby</h3>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {services.map((service) => (
                <li key={service}>
                  <Link href="/sluzby" className="text-sm transition-colors hover:text-white" style={{ color: "rgba(240,237,230,0.5)" }}>{service}</Link>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="py-6 flex flex-col sm:flex-row items-center justify-between gap-3" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          <p className="text-xs" style={{ color: "rgba(240,237,230,0.25)" }}>© {new Date().getFullYear()} AMEPRA s.r.o. Všechna práva vyhrazena.</p>
          <p className="text-xs" style={{ color: "rgba(240,237,230,0.25)" }}>Španělská 1073/10, 120 00 Praha 2</p>
        </div>
      </div>
    </footer>
  );
